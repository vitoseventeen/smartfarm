...
public class BuildTest {
    ...
    public void testStableInitialization() {
        Stable stable = new Stable("My Stable", 50);
    ...
    public void testHouseInitialization() {
        House house = new House("My House", 100);
        house.setFarmers( List.of(new Farmer("John", 30, new RestingState())));
        ...
        assertEquals(100, house.getCapacity(), "House capacity should be 100");
