...
public class PesticideAppliedState implements FieldState {
    ...
    public void plant(Field field) {
        System.out.println("The field with pesticides is not ready for planting.");
    }

    @Override
    public void harvest(Field field) {
        System.out.println("The field with pesticides is not ready for harvesting.");
    }

    @Override
    public void applyPesticides(Field field) {
        System.out.println("The field already has pesticides applied.");
